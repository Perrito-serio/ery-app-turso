...
export default function HomePage() {
  ...
  // --- MODIFICACIÓN ---: Lógica de redirección basada en roles.
  useEffect(() => {
    if (status === 'authenticated') {
      ...
      } else if (userRoles.includes('moderador_contenido')) {
  ...
  // Mientras se determina el estado y se redirige, mostramos un loader.
  // Esto evita que el usuario vea la landing page por un instante si ya está logueado.
  ...
  // Si el usuario no está autenticado, se muestra la Landing Page.
  return (
